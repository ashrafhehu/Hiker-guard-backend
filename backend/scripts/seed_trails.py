...
def seed_database():
    ...
    try:
        ...
        # Sample trail-pack-v1 payload compatible with mobile Zod validator
        payload_kledang = {
            ...
            "model": {
                ...
                "label_source": "Anatel Brazil 4G",
                "label_release": "2026-Q1",
                "label_resolution_m": 1000.0,
            ...
            "segments": [
                ...
                {
                    "segment_id": f"{kledang_id}__s00002",
                    "segment_order": 2,
                    "segment_length_m": 250.0,
                    "geometry": {
                        "type": "LineString",
        ...
        payload_larut = {
            ...
            "model": {
                ...
                "intended_use": "route_geometry_only",
                "field_validated": False,
                "label_source": "none",
                "label_release": "none",
                "label_resolution_m": 0.0,
                "prediction_support_m": 0.0,
                "approved_for_mobile_warning": False
            },
            "segments": [
                {
                    "segment_id": f"{larut_id}__s00001",
                    "segment_order": 1,
                    "segment_length_m": 250.0,
                    "geometry": {
                        "type": "LineString",
        ...
        db.commit()
        print("Database seeded successfully with mobile-compatible packs!")
